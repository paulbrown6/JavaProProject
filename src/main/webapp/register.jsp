...
<div class="single_top">
	 <div class="container"> 
	     <div class="register">
			 <% if (!(user == null)) {%>
			 <h3>ПОЗДРАВЛЯЕМ <% out.write(user.getFirstname().toUpperCase());%>, ВЫ УСПЕШНО ЗАРЕГИСТРИРОВАНЫ!</h3>
			 <% } else { %>
				 ...
				 <div class="register-top-grid">
					<h3>ПЕРСОНАЛЬНАЯ ИНФОРМАЦИЯ</h3>
					 <div>
						...
						<p class="error" style="color: red;">${errorfn}</p>
						<input type="text" name="firstname">
					 </div>
					 <div>
						<span>ФАМИЛИЯ<label>*</label></span>
						<p class="error" style="color: red;">${errorln}</p>
						<input type="text" name="lastname">
					 </div>
					 <div>
						 <span>EMAIL<label>*</label></span>
						 <p class="error" style="color: red;">${errorem}</p>
						 <input type="text" name="email">
					 </div>
					 <div class="clearfix"> </div>
					   <a class="news-letter">
						 <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i>ПОДПИСАТЬСЯ НА НОВОСТИ</label>
					   </a>
					 </div>
				     <div class="register-bottom-grid">
						    <h3>ИНФОРМАЦИЯ ДЛЯ ВХОДА</h3>
							 <p class="error" style="color: red;">${errorps}</p>
						 	<div>
							 ...
							 <div>
								...
								<input type="text" name="passresp">
							 </div>
							 <div class="clearfix"> </div>
					 </div>
				<div class="clearfix"> </div>
				<div class="register-but">
					   <input class="acount-btn" type="submit" value="Зарегистрироваться" style="border: 0">
					   <div class="clearfix"> </div>
				</div>
			  </form>
			 <% } %>
